...
HD_PWD='D:/digital_vlsi/pattern_detector/pattern_detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pattern_detector.tcl
