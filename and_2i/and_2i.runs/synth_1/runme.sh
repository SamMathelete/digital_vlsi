...
HD_PWD='D:/digital_vlsi/and_2i/and_2i.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_2i.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_2i.tcl
