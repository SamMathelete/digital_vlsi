...
HD_PWD='D:/digital_vlsi/On_Chip_Dual_Address_ROM/On_Chip_Dual_Address_ROM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log da_rom.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source da_rom.tcl -notrace
