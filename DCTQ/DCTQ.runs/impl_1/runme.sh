...
HD_PWD='D:/digital_vlsi/DCTQ/DCTQ.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_ram_rc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dual_ram_rc.tcl -notrace
