...
HD_PWD='D:/digital_vlsi/pci_arbitrator/pci_arbitrator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pci_arbiter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pci_arbiter.tcl -notrace
