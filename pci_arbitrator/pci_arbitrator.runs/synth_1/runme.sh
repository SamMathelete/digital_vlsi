...
HD_PWD='D:/digital_vlsi/pci_arbitrator/pci_arbitrator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pci_arbiter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pci_arbiter.tcl
